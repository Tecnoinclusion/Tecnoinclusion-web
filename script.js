  ...
  /* ---------- GRADO DÉCIMO ---------- */
  {
    ...
    subtemas:[
      {icon:'<i class="bi bi-123"></i>', label:'Sistemas de numeración', text:'El sistema binario usa solo dos símbolos (0 y 1) porque así "piensan" los circuitos de un computador: con corriente (1) o sin corriente (0). El sistema octal usa 8 símbolos (0 al 7) y el hexadecimal usa 16 (0 al 9, y después A, B, C, D, E, F) — estos dos existen porque son más cortos de escribir que un número binario larguísimo, y los programadores los usan para representar colores, direcciones de memoria y mucho más. Aprenderás a convertir números de un sistema a otro, entendiendo que cada sistema es simplemente "otra forma de contar lo mismo".',
        ...
        tiktoks:[{id:'7343925375778458885', url:'https://www.tiktok.com/@academiacateto/video/7343925375778458885', title:'Sistema binario explicado rápido'}],
        ...
        mq:[{q:'¿Cuántos símbolos usa el sistema octal?', opts:['8','2','16','10'], correct:0},{q:'El sistema binario representa la corriente eléctrica como...', opts:['Letras','0 y 1','Colores','Sonidos'], correct:1}], pic:[{emoji:'0️⃣1️⃣', q:'Esta imagen representa el sistema...', opts:['Octal','Binario','Decimal','Hexadecimal'], correct:1},{emoji:'🎨', q:'Los colores web usan códigos como #FF0000. ¿Qué sistema usan?', opts:['Romano','Hexadecimal','Binario','Decimal'], correct:1}]},
      {icon:'<i class="bi bi-lightning-charge-fill"></i>', label:'Electricidad y electrónica', text:'Antes de armar o reparar cualquier equipo, necesitas entender la electricidad que lo hace funcionar. La carga eléctrica es la propiedad de la materia que produce fuerzas eléctricas; la resistencia es lo que se opone al paso de la corriente; la tensión (o voltaje) es la fuerza que "empuja" los electrones; la corriente es el flujo de esos electrones; y la potencia y la energía indican cuánto trabajo puede hacer esa electricidad. Estos cinco conceptos son la base de toda la electrónica que verás en los próximos periodos.',
        ...
        mq:[{q:'¿Qué mide el voltaje?', opts:['El tamaño del computador','El color del cable','La velocidad del internet','La fuerza que empuja los electrones'], correct:3},{q:'La corriente eléctrica es...', opts:['El flujo de electrones','Un mouse','Un tipo de pantalla','Un programa'], correct:0}], pic:[{emoji:'🔋', q:'Esta imagen representa...', opts:['Un libro','Una fruta','Un balón','Una fuente de energía eléctrica'], correct:3},{emoji:'⚡', q:'Este símbolo representa...', opts:['El fuego','La corriente eléctrica','El viento','El agua'], correct:1}]},
      {icon:'<i class="bi bi-phone-fill"></i>', label:'Telefonía', text:'La telefonía móvil te permite comunicarte sin cables, usando antenas y ondas de radio que conectan tu celular con una red. El internet móvil funciona de manera parecida, permitiendo navegar, ver videos y comunicarte a través de esa misma red inalámbrica, sin depender de un cable físico conectado a tu casa.',
        ...
        mq:[{q:'La telefonía móvil permite comunicarse...', opts:['Solo con internet fijo','Nunca','Solo por escrito','Sin cables'], correct:3},{q:'¿Qué conecta el celular con la red móvil?', opts:['La impresora','Las antenas','El mouse','El teclado'], correct:1}], pic:[{emoji:'📱', q:'¿Qué usa este dispositivo para comunicarse sin cables?', opts:['Espejos','Antenas y ondas de radio','Solo cables','Humo'], correct:1},{emoji:'📶', q:'Este ícono indica...', opts:['Silencio','Batería baja','Modo avión','Señal de red móvil'], correct:3}]},
      {icon:'<i class="bi bi-pencil-square"></i>', label:'Anteproyecto', text:'Aquí das tus primeros pasos para planear tu proyecto de grado: eliges un problema real que quieras resolver con tecnología, estudias si es posible hacerlo (factibilidad), y piensas en cómo afecta tanto a las personas como al medio ambiente. También aprenderás a leer manuales técnicos, tanto en español como en inglés.',
        ...
        mq:[{q:'La factibilidad estudia si el proyecto...', opts:['Es gratis','Se puede realizar','Tiene colores bonitos','Es divertido'], correct:1},{q:'El anteproyecto de grado se hace...', opts:['Al mismo tiempo que se nace','Nunca','Después de graduarse','Antes de desarrollar el proyecto final'], correct:3}], pic:[{emoji:'📝', q:'Esta imagen representa...', opts:['Un videojuego','Un mapa','Una receta de cocina','Un documento de planeación'], correct:3},{emoji:'🎯', q:'Este símbolo representa...', opts:['Un objetivo a lograr','Un juego de azar','Un cuadro','Una moneda'], correct:0}]}
    ],
    ...
    quiz:[
      {q:'¿Qué números usa el sistema binario?', opts:['0 y 1','1 al 100','A a la Z','0 al 9'], correct:0},
      {q:'¿Qué es el voltaje?', opts:['Un programa','Un cable','Un color','La fuerza de la electricidad'], correct:3},
      {q:'Además del binario, ¿qué otro sistema de numeración existe?', opts:['Hexadecimal','Chino','Maya','Romano'], correct:0},
      {q:'Los computadores entienden mejor...', opts:['Números binarios','Dibujos','Palabras en español','Sonidos'], correct:0},
      {q:'¿Qué significa "bit"?', opts:['Un mouse','Dígito binario','Un tipo de cable','Una pantalla'], correct:1},
      {q:'La resistencia eléctrica se mide en...', opts:['Kilos','Litros','Ohmios','Metros'], correct:2},
      {q:'¿Cuántos símbolos usa el sistema hexadecimal?', opts:['2','8','10','16'], correct:3},
      {q:'La telefonía móvil permite...', opts:['Nada','Imprimir documentos','Solo usar internet fijo','Comunicarse sin cables'], correct:3}
    ]
  },
  {
    ...
    subtemas:[
      {icon:'<i class="bi bi-puzzle-fill"></i>', label:'Diagrama de flujo', text:'Un diagrama de flujo es la forma gráfica de mostrar un algoritmo, usando símbolos estandarizados: un óvalo marca el inicio o el final, un rectángulo representa un proceso o una acción, un rombo representa una decisión (sí/no), y un paralelogramo representa la entrada o salida de datos. Todo se conecta con flechas que muestran el orden exacto en que deben ejecutarse los pasos. Aprender a dibujar bien un diagrama de flujo facilita muchísimo escribir el programa después, porque ya tienes la lógica resuelta en papel.',
        ...
        mq:[{q:'¿Qué figura representa una decisión?', opts:['El rectángulo','El óvalo','El paralelogramo','El rombo'], correct:3},{q:'Un diagrama de flujo sirve para...', opts:['Conectar el internet','Imprimir documentos','Planear un algoritmo antes de programar','Borrar archivos'], correct:2}], pic:[{emoji:'🔷', q:'Este rombo en un diagrama de flujo representa...', opts:['Una decisión','El inicio','Un error','Un proceso'], correct:0},{emoji:'➡️', q:'Las flechas en un diagrama de flujo indican...', opts:['El orden de los pasos','Un error','El color','El tamaño'], correct:0}]},
      {icon:'<i class="bi bi-laptop"></i>', label:'Programación en C++ y Python', text:'C++ y Python son dos lenguajes de programación muy usados: C++ es más cercano a cómo funciona la máquina por dentro (por eso se usa mucho en sistemas que necesitan ser muy rápidos), mientras que Python tiene una sintaxis más sencilla de leer, ideal para aprender lógica de programación. En ambos aprenderás sobre variables (donde guardas un dato que puede cambiar, como la edad de una persona), constantes (un valor que nunca cambia, como el número Pi) y ciclos repetitivos (estructuras como "for" o "while" que repiten una acción muchas veces sin que tengas que escribirla una y otra vez).',
        ...
        mq:[{q:'¿Qué guarda una variable?', opts:['Un color','Un cable','Un dato que puede cambiar','Una imagen fija'], correct:2},{q:'C++ se usa mucho porque...', opts:['Es el único lenguaje que existe','Es rápido y cercano al funcionamiento de la máquina','No sirve para programar','Es un sistema operativo'], correct:1}], pic:[{emoji:'🐍', q:'Este animal es el logo de qué lenguaje de programación...', opts:['HTML','C++','Java','Python'], correct:3},{emoji:'💻', q:'Esta imagen representa...', opts:['Escribir código de programación','Cocinar','Ver televisión','Dibujar'], correct:0}]},
      {icon:'<i class="bi bi-pencil-square"></i>', label:'Anteproyecto', text:'Sigues construyendo tu propuesta de proyecto de grado: defines el título definitivo, escribes un resumen claro de qué vas a hacer, planteas tus objetivos general y específicos, delimitas hasta dónde llega tu proyecto (alcances) y qué no vas a cubrir (limitaciones), describes las actividades que vas a realizar, armas un cronograma con fechas, y empiezas a recopilar la bibliografía que vas a usar.',
        ...
        mq:[{q:'El anteproyecto de grado sirve para...', opts:['Formatear el computador','Instalar Windows','Planear el proyecto antes de desarrollarlo','Ver videos'], correct:2},{q:'Las limitaciones de un proyecto indican...', opts:['La marca del computador','El color del informe','Qué no se va a cubrir','El nombre del autor'], correct:2}], pic:[{emoji:'📅', q:'Este ícono representa el...', opts:['Clima','Menú del restaurante','Cronograma de actividades','Horóscopo'], correct:2},{emoji:'🔍', q:'Esta imagen representa...', opts:['Buscar un tesoro','Perder algo','Investigar el problema del proyecto','Espiar a alguien'], correct:2}]}
    ],
    ...
    quiz:[
      {q:'Un algoritmo es...', opts:['Un dibujo sin sentido','Un cable','Una pantalla','Una lista de pasos ordenados'], correct:3},
      {q:'¿Qué usamos para planear un algoritmo antes de programar?', opts:['Un diagrama de flujo','Un cable de red','Una impresora','Un mouse'], correct:0},
      {q:'¿Cuál es un lenguaje de programación?', opts:['Inglés','Python','Español','Binario'], correct:1},
      {q:'Si el orden de los pasos está mal...', opts:['No importa','El resultado puede salir mal','Siempre funciona','Se arregla solo'], correct:1},
      {q:'Una variable en programación es...', opts:['Un mouse','Un color','Un cable','Un espacio que guarda un valor'], correct:3},
      {q:'Un ciclo repetitivo sirve para...', opts:['Apagar el computador','Repetir una acción varias veces','Borrar el programa','Nada'], correct:1},
      {q:'Además de C++, ¿qué otro lenguaje aprenderás?', opts:['Ninguno','Python','Español','Binario puro'], correct:1},
      {q:'Una constante es un valor que...', opts:['Es un color','Es un cable','No cambia durante el programa','Cambia todo el tiempo'], correct:2}
    ]
  },
  {
    ...
    subtemas:[
      {icon:'<i class="bi bi-pc-display"></i>', label:'Arquitectura de computadores', text:'Se refiere a cómo están organizadas todas las piezas del computador: el procesador (que ejecuta las instrucciones), la memoria RAM (donde se guardan los datos mientras el equipo está encendido), el disco duro o SSD (donde se guarda la información de forma permanente), la tarjeta madre (que conecta todo entre sí), la fuente de poder (que entrega la electricidad correcta a cada componente), y los periféricos (dispositivos externos como el teclado, el mouse, el monitor o la impresora).',
        ...
        mq:[{q:'¿Qué hace el procesador?', opts:['Imprime documentos','Da estilo a la página','Guarda información para siempre','Ejecuta las instrucciones'], correct:3},{q:'Un periférico es...', opts:['La memoria RAM','Un cable interno','El procesador','Un dispositivo externo como el teclado'], correct:3}], pic:[{emoji:'🖥️', q:'Esta imagen representa...', opts:['El computador completo','Un televisor','Una impresora','Un microondas'], correct:0},{emoji:'🧠', q:'Este ícono representa qué parte del computador...', opts:['La pantalla','El procesador (CPU)','El cable','El mouse'], correct:1}]},
      {icon:'<i class="bi bi-wrench-adjustable"></i>', label:'Mantenimiento', text:'El mantenimiento preventivo se hace de forma periódica, antes de que aparezca cualquier problema: limpiar el polvo, revisar cables, verificar temperaturas. El mantenimiento predictivo usa herramientas de monitoreo para anticipar cuándo es probable que falle una pieza, basándose en su comportamiento (por ejemplo, un disco duro que empieza a hacer ruidos raros). El mantenimiento correctivo es el que se hace cuando el daño ya ocurrió: identificar la falla exacta y repararla o cambiar la pieza dañada. Los tres tipos son complementarios y un buen técnico sabe cuándo aplicar cada uno.',
        ...
        mq:[{q:'El mantenimiento predictivo busca...', opts:['Anticiparse a una falla','Ignorar el problema','Dañar el equipo','Nada'], correct:0},{q:'¿Qué mantenimiento se hace cuando el equipo ya falló?', opts:['Preventivo','Correctivo','Ninguno','Predictivo'], correct:1}], pic:[{emoji:'🧹', q:'Esta imagen representa qué tipo de mantenimiento...', opts:['Predictivo solamente','Ninguno','Correctivo','Preventivo'], correct:3},{emoji:'🔧', q:'Esta herramienta se usa para...', opts:['Cocinar','Pintar','Escribir','Reparar y dar mantenimiento'], correct:3}]},
      {icon:'<i class="bi bi-rulers"></i>', label:'Instrumentos de medición', text:'El voltímetro mide la diferencia de tensión (voltaje) entre dos puntos de un circuito. El amperímetro mide la intensidad de corriente que fluye. El generador de señales produce ondas eléctricas de prueba para verificar que un circuito responde correctamente. El osciloscopio muestra gráficamente cómo cambia una señal eléctrica en el tiempo, siendo clave para diagnosticar problemas complejos. La pinza multifunción combina varias de estas mediciones en una sola herramienta portátil, muy usada en el trabajo de campo.',
        ...
        mq:[{q:'¿Qué instrumento mide el voltaje?', opts:['El voltímetro','El teclado','La impresora','El mouse'], correct:0},{q:'El osciloscopio es útil para...', opts:['Nada','Diagnosticar problemas viendo señales eléctricas','Navegar en internet','Escuchar música'], correct:1}], pic:[{emoji:'📟', q:'Este instrumento mide...', opts:['La temperatura del cuerpo','El peso','La distancia','Voltaje y corriente'], correct:3},{emoji:'📈', q:'Esta gráfica representa una señal vista en un...', opts:['Libro','Reloj','Televisor','Osciloscopio'], correct:3}]}
    ],
    ...
    quiz:[
      {q:'La arquitectura de un computador es...', opts:['Un programa','Cómo están organizadas sus partes','Un cable','Un edificio'], correct:1},
      {q:'¿Qué instrumento mide la electricidad?', opts:['El voltímetro','El parlante','El mouse','El teclado'], correct:0},
      {q:'El mantenimiento sirve para...', opts:['Dañar el computador','Cuidar el computador y evitar daños','Apagarlo para siempre','Nada'], correct:1},
      {q:'¿Cuál es una parte del hardware?', opts:['Un archivo de texto','Una página web','Un correo','El procesador'], correct:3},
      ...
      {q:'Un periférico es...', opts:['Un dispositivo externo como el mouse o la impresora','Un programa','Solo el procesador','Un cable de red'], correct:0},
      {q:'El osciloscopio sirve para...', opts:['Imprimir documentos','Ver señales eléctricas en una gráfica','Navegar en internet','Escuchar música'], correct:1},
      {q:'El mantenimiento correctivo se hace cuando...', opts:['Todo funciona bien','Antes de comprarlo','El equipo ya presenta una falla','Nunca es necesario'], correct:2}
    ]
  },
  {
    ...
    subtemas:[
      {icon:'<i class="bi bi-floppy-fill"></i>', label:'Sistemas operativos', text:'Un sistema operativo es el programa que se ejecuta primero al encender un computador y que administra todos los recursos: qué programa usa el procesador en cada momento, dónde se guarda cada archivo, cómo se comunica el equipo con el teclado, el mouse o la pantalla. Sin sistema operativo, el hardware no sabría qué hacer. Windows, Linux y macOS son los sistemas operativos más comunes para computadores, mientras que Android e iOS dominan en celulares.',
        ...
        mq:[{q:'¿Qué hace el sistema operativo?', opts:['Nada','Administra todos los recursos del equipo','Solo reproduce música','Solo imprime documentos'], correct:1},{q:'¿Cuál es un sistema operativo para celulares?', opts:['Word','Excel','Chrome','Android'], correct:3}], pic:[{emoji:'🪟', q:'Este ícono representa qué sistema operativo...', opts:['Una ventana de casa','Windows','Un espejo','Un cuadro'], correct:1},{emoji:'🤖', q:'Este ícono representa qué sistema operativo de celulares...', opts:['Android','Windows','Un juguete','Una aspiradora'], correct:0}]},
      {icon:'<i class="bi bi-folder-fill"></i>', label:'Formateo', text:'Formatear significa preparar un disco para guardar información, borrando todo lo que tenía antes y organizándolo según un sistema de archivos: NTFS (usado por Windows, permite archivos muy grandes y más seguridad), FAT (uno de los sistemas más antiguos y simples) o FAT32 (una versión mejorada de FAT, muy compatible entre distintos dispositivos, pero con límite en el tamaño de archivo). Formatear es un proceso delicado porque borra TODA la información, así que siempre se debe respaldar lo importante antes de hacerlo.',
        ...
        mq:[{q:'Antes de formatear es importante...', opts:['Romper el disco','No hacer nada','Respaldar la información importante','Desconectar todo para siempre'], correct:2},{q:'¿Qué sistema de archivos usa Windows normalmente?', opts:['MP3','PDF','JPG','NTFS'], correct:3}], pic:[{emoji:'💽', q:'Esta imagen representa...', opts:['Una moneda','Un plato','Un disco de almacenamiento','Un CD de música'], correct:2},{emoji:'🗑️', q:'Formatear un disco significa...', opts:['Pintarlo','Nada','Borrar todo y prepararlo de nuevo','Guardar todo para siempre'], correct:2}]},
      {icon:'<i class="bi bi-file-earmark-text-fill"></i>', label:'Informes técnicos', text:'Un buen técnico no solo sabe hacer el trabajo, también sabe explicarlo por escrito. Aprenderás a redactar informes técnicos claros y organizados, aplicando normas de citación y formato como IEEE (muy usada en ingeniería), Icontec (estándar colombiano) o APA (muy usada en ciencias sociales), según lo que pida cada trabajo o tu proyecto de grado.',
        ...
        mq:[{q:'¿Qué norma es un estándar colombiano?', opts:['Icontec','HTML','IEEE','APA'], correct:0},{q:'Un informe técnico sirve para...', opts:['Explicar por escrito el trabajo realizado','Nada','Formatear el computador','Borrar el disco'], correct:0}], pic:[{emoji:'📄', q:'Esta imagen representa...', opts:['Una canción','Una fotografía','Un informe o documento escrito','Un video'], correct:2},{emoji:'🖊️', q:'Esta imagen representa la acción de...', opts:['Redactar y citar correctamente','Borrar el documento','Imprimir a color','Dibujar'], correct:0}]}
    ],
    ...
    quiz:[
      {q:'El sistema operativo es...', opts:['Un cable','El programa principal que hace funcionar el computador','Una impresora','Un mouse'], correct:1},
      {q:'¿Cuál es un ejemplo de sistema operativo?', opts:['YouTube','WhatsApp','Windows','Word'], correct:2},
      {q:'Formatear un computador significa...', opts:['Apagarlo','Borrar todo y dejarlo como nuevo','Prenderlo','Limpiarlo con agua'], correct:1},
      {q:'El sistema operativo organiza...', opts:['Solo la música','Los archivos y programas','Nada','Solo los colores'], correct:1},
      {q:'NTFS y FAT32 son...', opts:['Marcas de computador','Sistemas de archivos','Colores de pantalla','Tipos de mouse'], correct:1},
      {q:'Antes de formatear es importante...', opts:['Desconectar todo para siempre','No hacer nada','Romper el computador','Respaldar la información importante'], correct:3},
      {q:'Una licencia de software indica...', opts:['El color del programa','Si el programa se puede usar legalmente','El tamaño de la pantalla','Nada'], correct:1},
      {q:'Un informe técnico debe ser...', opts:['Solo con dibujos','Muy corto sin explicar nada','Confuso','Claro y organizado'], correct:3}
    ]
  },
  /* ---------- GRADO ONCE ---------- */
  {
    ...
    subtemas:[
      {icon:'<i class="bi bi-plug-fill"></i>', label:'Tarjeta Arduino', text:'Arduino Uno es una placa con un microcontrolador (un pequeño "cerebro" programable), pines digitales y analógicos para conectar sensores y actuadores, un puerto USB para programarla desde el computador, y un regulador de voltaje que asegura que todo funcione con la energía correcta. Su software (el IDE de Arduino) te permite escribir el código, llamado "sketch", y cargarlo directamente en la placa.',
        ...
        mq:[{q:'¿Qué es Arduino?', opts:['Una tarjeta electrónica programable','Un cable','Un programa de dibujo','Un mouse'], correct:0},{q:'El código de Arduino se llama...', opts:['PDF','Excel','Sketch','Word'], correct:2}], pic:[{emoji:'🔌', q:'Esta imagen representa...', opts:['Una impresora','Un teclado','Una placa Arduino','Un mouse'], correct:2},{emoji:'💾', q:'El código de Arduino que subes a la placa se llama...', opts:['Excel','Word','PDF','Sketch'], correct:3}]},
      {icon:'<i class="bi bi-lightbulb-fill"></i>', label:'Entradas y salidas', text:'Las salidas digitales solo tienen dos estados (encendido/apagado), como un LED que prendes y apagas, o una secuencia de varios LEDs. Las entradas digitales leen ese mismo tipo de señal desde afuera, como saber si un botón está presionado o no. Las entradas analógicas pueden leer un rango completo de valores, como la cantidad de luz que capta una fotocelda, la posición de un potenciómetro, o la dirección de un joystick. Las salidas analógicas usan una técnica llamada PWM para simular distintos niveles de intensidad, por ejemplo variando el brillo de un LED o la velocidad de un motor DC.',
        ...
        mq:[{q:'Encender y apagar un LED es un ejemplo de...', opts:['Entrada analógica','Salida digital','Formateo','Sistema operativo'], correct:1},{q:'El PWM sirve para...', opts:['Apagar el computador','Borrar el programa','Nada','Variar la intensidad de una señal'], correct:3}], pic:[{emoji:'💡', q:'Esta imagen representa una salida...', opts:['Analógica pura','Sonora','Ninguna','Digital'], correct:3},{emoji:'🎚️', q:'Este control representa una entrada...', opts:['Sonora','Analógica','Visual','Digital'], correct:1}]},
      {icon:'<i class="bi bi-car-front-fill"></i>', label:'Proyecto', text:'Todo lo aprendido se aplica en un proyecto real y motivador: un carro seguidor de línea, un pequeño robot que usa sensores para detectar una línea pintada en el suelo y ajustar sus motores automáticamente para seguirla sin salirse del camino. Este proyecto combina sensores, actuadores y programación en un solo sistema funcionando en conjunto.',
        ...
        mq:[{q:'¿Qué detecta el carro seguidor de línea?', opts:['Una línea pintada en el suelo','La hora','El clima','La música'], correct:0},{q:'¿Qué combina este proyecto?', opts:['Solo sonido','Sensores, actuadores y programación','Solo texto','Solo dibujos'], correct:1}], pic:[{emoji:'🚗', q:'Esta imagen representa el proyecto de...', opts:['Carro seguidor de línea','Un barco','Un dron','Un avión'], correct:0},{emoji:'👁️', q:'Este ícono representa la función de un...', opts:['Cable','Tornillo','Sensor','Motor'], correct:2}]}
    ],
    ...
    quiz:[
      {q:'Arduino es...', opts:['Un cable USB','Una tarjeta electrónica programable','Un programa de dibujo','Un mouse'], correct:1},
      {q:'Un sensor sirve para...', opts:['Navegar en internet','Imprimir','Detectar luz, temperatura o movimiento','Escuchar música'], correct:2},
      {q:'¿Qué puede mover un actuador como un motor?', opts:['Ruedas o brazos de un robot','Nada','Solo el teclado','Solo el mouse'], correct:0},
      {q:'Programar Arduino permite...', opts:['Ver televisión','Cocinar','Encender luces y mover motores','Dormir'], correct:2},
      {q:'Un actuador es un dispositivo que...', opts:['Solo mide temperatura','Produce un movimiento o acción','Solo se ve bonito','No hace nada'], correct:1},
      {q:'Una entrada digital puede leer...', opts:['Nada','La velocidad del viento','Si un botón está presionado o no','El color del cielo'], correct:2},
      {q:'El PWM se usa para...', opts:['Apagar el computador','Variar la intensidad de una señal','Cambiar el idioma','Borrar un programa'], correct:1},
      {q:'Un servomotor puede...', opts:['Girar a un ángulo específico','Solo hacer sonido','Solo encender una luz','Nada'], correct:0}
    ]
  },
  {
    ...
    subtemas:[
      {icon:'<i class="bi bi-globe"></i>', label:'Tipos de redes', text:'Una LAN (Local Area Network) conecta equipos en un espacio pequeño como un salón, un edificio o un colegio, y normalmente la administra una sola organización. Una MAN (Metropolitan Area Network) cubre un área más grande, como una ciudad completa. Una WAN (Wide Area Network) conecta redes a través de países o continentes enteros — internet es el ejemplo más grande de una WAN, formada por millones de redes más pequeñas conectadas entre sí.',
        ...
        tiktoks:[{id:'7490713678577208631', url:'https://www.tiktok.com/@cinatelsas/video/7490713678577208631', title:'¿Qué es una red LAN?'}],
        ...
        mq:[{q:'Una red pequeña como la del colegio se llama...', opts:['LAN','Ninguna','WAN','MAN gigante'], correct:0},{q:'¿Qué tipo de red es internet?', opts:['Solo un cable','WAN','LAN','Ninguna'], correct:1}], pic:[{emoji:'🏫', q:'Una red dentro de un solo edificio se llama...', opts:['WAN','LAN','Internet completo','Ninguna'], correct:1},{emoji:'🌍', q:'Esta imagen representa una red tipo...', opts:['WAN (mundial)','Solo un cable','LAN pequeña','Ninguna'], correct:0}]},
      {icon:'<i class="bi bi-signpost-split-fill"></i>', label:'Topologías', text:'La topología de bus conecta todos los equipos a un único cable central, es simple pero si el cable falla toda la red se cae. La topología de estrella conecta cada equipo directamente a un punto central (como un switch), de forma que si un cable falla solo afecta a ese equipo, no a toda la red — es la más usada actualmente. La topología de árbol combina varias estrellas en una estructura jerárquica, útil para redes grandes con varios departamentos o pisos.',
        ...
        mq:[{q:'¿Cuál es la topología más usada actualmente?', opts:['Anillo doble','Ninguna','Bus antiguo','Estrella'], correct:3},{q:'La topología de árbol combina...', opts:['Solo un cable','Nada','Varias estrellas','Solo routers'], correct:2}], pic:[{emoji:'⭐', q:'Esta forma representa la topología de...', opts:['Anillo','Bus','Estrella','Árbol'], correct:2},{emoji:'➖', q:'Esta línea representa la topología de...', opts:['Malla','Bus','Estrella','Árbol'], correct:1}]},
      {icon:'<i class="bi bi-compass-fill"></i>', label:'Direccionamiento IP', text:'Cada dispositivo conectado a una red necesita una dirección IP única, similar a la dirección de una casa, para que los datos sepan exactamente a dónde llegar. Las IP públicas son visibles desde internet y las asigna tu proveedor de servicio; las IP privadas (de clase A, B o C) se usan dentro de una red local y no son visibles directamente desde internet, lo que también ayuda a la seguridad.',
        ...
        mq:[{q:'¿Quién asigna la IP pública?', opts:['Nadie','El usuario final siempre','El proveedor de servicio de internet','El teclado'], correct:2},{q:'Una IP privada se usa...', opts:['Solo en el extranjero','Dentro de una red local','En ningún dispositivo','Nunca'], correct:1}], pic:[{emoji:'🏠', q:'Una IP privada es como la dirección de...', opts:['El espacio exterior','Un país entero','Nada','Una casa dentro de un barrio'], correct:3},{emoji:'🌐', q:'Esta imagen representa una IP...', opts:['De un teléfono viejo','Pública, visible en internet','De un CD','Inexistente'], correct:1}]}
    ],
    ...
    quiz:[
      {q:'Una red conecta...', opts:['Un lápiz y un papel','Solo un computador','Varios computadores entre sí','Nada'], correct:2},
      {q:'Una red pequeña como la del colegio se llama...', opts:['Ninguna','Internet gigante','LAN','WAN'], correct:2},
      {q:'La dirección IP es...', opts:['Una contraseña de WiFi','Un color','Un sonido','El nombre único de un computador en la red'], correct:3},
      ...
      {q:'Un router sirve para...', opts:['Escuchar música','Nada','Conectar redes distintas y dirigir el tráfico','Guardar archivos'], correct:2},
      {q:'Una topología de estrella conecta los equipos...', opts:['En línea recta','A través de un punto central','De forma aleatoria','Sin ningún orden'], correct:1},
      {q:'Un switch sirve para...', opts:['Nada','Conectar redes distintas entre países','Conectar varios dispositivos dentro de una misma red','Imprimir'], correct:2}
    ]
  },
  {
    ...
    subtemas:[
      {icon:'<i class="bi bi-link-45deg"></i>', label:'Cableado estructurado', text:'Las normas TIA/EIA 568A y 568B definen el orden exacto de los colores de los cables dentro de un conector RJ45, para que cualquier técnico en el mundo pueda instalar o reparar una red siguiendo el mismo estándar. Otras normas como ANSI/TIA 606B, ISO/IEC 14763-1 y EN 50174-1 regulan la administración, etiquetado y buenas prácticas de instalación, asegurando que una red sea fácil de mantener y ampliar en el futuro.',
        ...
        mq:[{q:'¿Qué define la norma TIA/EIA 568?', opts:['El precio del cable','El color de la pared','El orden de los colores del cable','Nada'], correct:2},{q:'Un cableado bien organizado ayuda a...', opts:['Perder tiempo','Nada','Que la red funcione mejor','Dañar la red'], correct:2}], pic:[{emoji:'🔌', q:'Este conector se llama...', opts:['HDMI','USB','Auxiliar','RJ45'], correct:3},{emoji:'🎨', q:'Los colores de un cable de red siguen la norma...', opts:['ISO 9001','Ninguna norma','TIA/EIA 568','Icontec 1486'], correct:2}]},
      {icon:'<i class="bi bi-diagram-2-fill"></i>', label:'Packet Tracer', text:'Cisco Packet Tracer es un simulador que permite armar redes completas de forma virtual: agregar computadores, switches, routers, cables, y configurarlos exactamente como lo harías con equipos reales. Esto permite practicar, cometer errores y aprender sin gastar dinero en equipos ni arriesgar dañar una red real. Aprenderás sobre el gateway (la puerta de enlace que conecta tu red con otras), DHCP (que asigna direcciones IP automáticamente) y VLAN (redes virtuales que dividen lógicamente una misma red física).',
        ...
        mq:[{q:'¿Para qué sirve Cisco Packet Tracer?', opts:['Editar fotos','Ver películas','Nada','Simular redes en la pantalla'], correct:3},{q:'El DHCP sirve para...', opts:['Borrar archivos','Formatear discos','Asignar direcciones IP automáticamente','Nada'], correct:2}], pic:[{emoji:'🖧', q:'Esta imagen representa un dispositivo de red llamado...', opts:['Router o switch','Impresora','Mouse','Teclado'], correct:0},{emoji:'🧪', q:'Cisco Packet Tracer sirve para...', opts:['Escuchar música','Dibujar','Ver películas','Simular redes sin dañar equipos reales'], correct:3}]},
      {icon:'<i class="bi bi-signpost-2-fill"></i>', label:'Enrutamiento', text:'Una ruta estática es un camino que el administrador de la red configura manualmente para que los datos sepan exactamente por dónde ir. Los protocolos de enrutamiento dinámico, como OSPF y EIGRP, permiten que los routers descubran automáticamente las mejores rutas y se adapten solos si algo cambia en la red, sin necesitar configuración manual constante.',
        ...
        mq:[{q:'¿Qué hace un protocolo de enrutamiento dinámico?', opts:['Apaga los routers','Nada','Borra la red','Descubre automáticamente las mejores rutas'], correct:3},{q:'Una ruta estática se configura...', opts:['Nunca','Manualmente por el administrador','Por el usuario final','Sola, sin ayuda'], correct:1}], pic:[{emoji:'🗺️', q:'Una ruta estática es como seguir un mapa...', opts:['Que cambia solo','Al azar','Fijo, configurado a mano','Inexistente'], correct:2},{emoji:'🔀', q:'Esta imagen representa que los datos pueden tomar...', opts:['Ningún camino','Un camino cerrado','Solo un camino posible','Distintas rutas hacia su destino'], correct:3}]}
    ],
    ...
    quiz:[
      {q:'El cableado estructurado sigue...', opts:['Normas y reglas de instalación','Ningún orden','Nada','Solo colores bonitos'], correct:0},
      {q:'Cisco Packet Tracer sirve para...', opts:['Jugar','Simular redes en la pantalla','Ver videos','Imprimir documentos'], correct:1},
      {q:'¿Por qué es útil simular una red antes de armarla?', opts:['Para hacer ruido','Para perder tiempo','No sirve para nada','Para practicar sin dañar equipos reales'], correct:3},
      {q:'Los cables de red bien organizados ayudan a...', opts:['Que se vea bonito nada más','Que la red funcione mejor','Nada','Dañar la red'], correct:1},
      {q:'La fibra óptica transmite datos usando...', opts:['Sonido','Agua','Luz','Electricidad únicamente'], correct:2},
      {q:'Una ruta estática se configura...', opts:['Sola, sin ayuda','Nunca','Manualmente por el administrador de red','Por el usuario final siempre'], correct:2},
      {q:'El estándar TIA/EIA 568 regula...', opts:['Nada','El cableado estructurado','El software del computador','Los colores de la ropa'], correct:1},
      {q:'Simular una red antes de instalarla ayuda a...', opts:['Complicar el trabajo','Nada','Detectar errores sin gastar en equipos reales','Perder el tiempo'], correct:2}
    ]
  },
  {
    ...
    subtemas:[
      {icon:'<i class="bi bi-globe2"></i>', label:'Historia de internet', text:'Internet nació como un proyecto militar y académico en los años 60, pensado para conectar computadores en red incluso si parte de la red fallaba. Décadas después, en 1989, Tim Berners-Lee propuso la World Wide Web: un sistema de documentos conectados por hipervínculos, mucho más fácil de usar. A partir de ahí aparecieron los primeros navegadores web, que permitieron a cualquier persona "ver" esas páginas, y el lenguaje HTML, que definía cómo se estructuraba el contenido de cada página.',
        ...
        mq:[{q:'¿Quién propuso la World Wide Web?', opts:['Tim Berners-Lee','Steve Jobs','Bill Gates','Mark Zuckerberg'], correct:0},{q:'Un navegador web sirve para...', opts:['Ver páginas web en internet','Nada','Escuchar música únicamente','Imprimir documentos'], correct:0}], pic:[{emoji:'🕸️', q:'Esta imagen representa...', opts:['Un juego','Una telaraña real','La World Wide Web','Un mapa'], correct:2},{emoji:'🧑‍💻', q:'Esta persona propuso la World Wide Web en 1989...', opts:['Elon Musk','Bill Gates','Steve Jobs','Tim Berners-Lee'], correct:3}]},
      {icon:'<i class="bi bi-building"></i>', label:'HTML y CSS', text:'HTML (HyperText Markup Language) es el lenguaje que arma el "esqueleto" de una página: títulos, párrafos, imágenes, botones, enlaces. Cada elemento se marca con etiquetas, como &lt;h1&gt; para un título grande o &lt;p&gt; para un párrafo. CSS (Cascading Style Sheets) le da estilo a ese esqueleto: colores, tamaños, espacios, animaciones. Con CSS3 (la versión actual) se pueden lograr diseños muy sofisticados, y existen frameworks de CSS (conjuntos de reglas ya hechas) que aceleran mucho el trabajo de diseño.',
        ...
        mq:[{q:'El HTML se usa para...', opts:['Pintar paredes','Armar la estructura de una página web','Escuchar música','Cocinar'], correct:1},{q:'El CSS le da a la página...', opts:['Color y estilo','Sonido','Solo texto sin forma','Nada'], correct:0}], pic:[{emoji:'🏗️', q:'HTML arma qué parte de una página web...', opts:['Solo el color','La estructura (el esqueleto)','Nada','El sonido'], correct:1},{emoji:'🎨', q:'Esta imagen representa lo que hace...', opts:['CSS: darle estilo y color','JavaScript: la interacción','El servidor','HTML: la estructura'], correct:0}]},
      {icon:'<i class="bi bi-gear-fill"></i>', label:'JavaScript', text:'Si HTML es el esqueleto y CSS es la ropa, JavaScript son los músculos: es el lenguaje que hace que la página reaccione — que un botón haga algo al hacer clic, que aparezca un mensaje, que se guarde información, o que (como en este mismo sitio) funcionen los juegos y las evaluaciones interactivas. Aprenderás conceptos básicos y avanzados de este lenguaje fundamental del desarrollo web moderno.',
        ...
        mq:[{q:'JavaScript le da a la página...', opts:['Nada','Solo texto','Movimiento e interacción','Solo colores'], correct:2},{q:'Los juegos de este sitio funcionan gracias a...', opts:['Solo CSS','JavaScript','Solo HTML','Ninguno'], correct:1}], pic:[{emoji:'⚙️', q:'Esta imagen representa lo que le da JavaScript a la página...', opts:['Solo texto','Solo color','Movimiento e interacción','Nada'], correct:2},{emoji:'🖱️', q:'Un clic en un botón que hace algo es un ejemplo de...', opts:['Ninguno','Solo HTML','Solo CSS','Evento de JavaScript'], correct:3}]},
      {icon:'<i class="bi bi-cloud-fill"></i>', label:'Computación en la nube', text:'La computación en la nube permite usar programas y almacenar información a través de internet, sin necesitar instalarlo todo en tu propio computador. SaaS (Software as a Service) es un programa que usas directamente desde el navegador, como el correo electrónico. PaaS (Platform as a Service) ofrece una plataforma lista para que los desarrolladores construyan aplicaciones sin preocuparse por la infraestructura. IaaS (Infrastructure as a Service) alquila la infraestructura misma (servidores, almacenamiento) para que una empresa monte lo que necesite sobre ella.',
        ...
        mq:[{q:'El correo electrónico que usas desde el navegador es un ejemplo de...', opts:['IaaS','Ninguno','PaaS','SaaS'], correct:3},{q:'¿Qué permite usar programas sin instalarlos en tu computador?', opts:['Nada','La computación en la nube','El mantenimiento correctivo','El formateo'], correct:1}], pic:[{emoji:'☁️', q:'Esta imagen representa...', opts:['Un videojuego','Un dibujo','La computación en la nube','El clima'], correct:2},{emoji:'📧', q:'Usar el correo electrónico desde el navegador es un ejemplo de...', opts:['PaaS','IaaS','SaaS','Ninguno'], correct:2}]}
    ],
    ...
    quiz:[
      {q:'El HTML se usa para...', opts:['Escuchar música','Armar la estructura de una página web','Pintar paredes','Cocinar'], correct:1},
      {q:'El CSS le da a la página...', opts:['Color y estilo','Sonido','Solo texto sin forma','Nada'], correct:0},
      {q:'JavaScript le da a la página...', opts:['Movimiento e interacción','Nada','Solo texto','Solo colores'], correct:0},
      {q:'Con HTML, CSS y JavaScript se pueden crear...', opts:['Solo dibujos en papel','Solo música','Nada de eso','Páginas web'], correct:3},
      {q:'¿Quién propuso la World Wide Web?', opts:['Mark Zuckerberg','Steve Jobs','Tim Berners-Lee','Bill Gates'], correct:2},
      {q:'Un navegador web sirve para...', opts:['Ver páginas web en internet','Nada','Escuchar música únicamente','Imprimir documentos'], correct:0},
      {q:'SaaS significa que un programa...', opts:['Se debe instalar siempre','Se usa desde internet sin instalarlo','Es gratis siempre','No funciona nunca'], correct:1},
      {q:'Las etiquetas en HTML sirven para...', opts:['Definir la estructura del contenido','Pintar la pared','Nada','Tocar música'], correct:0}
    ]
  }
];
...
function loadTikTokEmbedScript(){
  if(document.getElementById('tiktokEmbedScript')) return;
