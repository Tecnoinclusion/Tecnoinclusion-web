...
function showUserBadge(){
  ...
  el.innerHTML = `<i class="bi bi-person-circle"></i> ${currentDisplayName}${gradoLbl} <button id="logoutBtn" type="button" title="Cerrar sesión"><i class="bi bi-box-arrow-right"></i></button>`;
