...
function showLoginGate(){
  ...
  overlay.innerHTML = `
    <div class="login-card">
      ...
      <p>Escribe tu nombre y el código de acceso que te dio tu profesor para guardar tu progreso.</p>
...
function showUserBadge(){
  ...
  el.innerHTML = `<i class="bi bi-person-circle"></i> ${currentDisplayName} <button id="logoutBtn" type="button" title="Cerrar sesión"><i class="bi bi-box-arrow-right"></i></button>`;
